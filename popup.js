...
function renderDiagnostics(s) {
  ...
  if(diagEl.spatialCuePreserve)diagEl.spatialCuePreserve.textContent=Number.isFinite(Number(sp.cuePreservationFactor))?Number(sp.cuePreservationFactor).toFixed(2):"--";
